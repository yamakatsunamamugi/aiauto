...
Gemini (https://gemini.google.com) の自動操作を実装
...
class GeminiHandler(BaseAIHandler):
    ...
    async def get_response_selector(self) -> str:
        ...
        Returns:
            str: 応答エリアのCSSセレクター
        """
        return ".response-container, .message-content, .model-response, [data-response-id]"
